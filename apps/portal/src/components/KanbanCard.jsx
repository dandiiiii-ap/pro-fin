                ...
                {item.stage === 'invoice' && (
                    <div className="bg-orange-50 dark:bg-orange-900/10 p-2 rounded border border-orange-100 dark:border-orange-800/30 flex flex-col gap-2">
                        <div className="flex items-center justify-between text-xs">
                            ...
                            <span className={`font-semibold ${item.status === 'Unpaid' ? 'text-red-500' : (item.status === 'Lunas' ? 'text-green-500' : 'text-slate-700 dark:text-slate-300')} truncate pl-2`}>
                                {item.status || item.paymentStatus || 'Unpaid'}
                            </span>
                        </div>
                        <div className="flex items-center justify-between text-xs pt-1.5 border-t border-orange-100 dark:border-orange-800/30">
                            ...
                            <span className="font-medium text-slate-700 dark:text-slate-300">{item.due?.replace('Due: ', '') || 'TBD'}</span>
                        </div>
