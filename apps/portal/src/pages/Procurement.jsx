...
const initialData = {
    items: {
        ...
        'inv-993': { id: 'inv-993', code: '#INV-993', type: 'Material', project: 'Finance Dept', title: 'Wiremesh M8', vol: '500 Lembar', total: 'Rp 325.000.000', status: 'Unpaid', userAvatar: 'https://lh3.googleusercontent.com/aida-public/AB6AXuATwKZSAYvfPNu-FPVflOnemqQBDAyH5PiXUbvVpq-zxo9BeumCFlbxs1i3eifTRE6YVngrLI1bVt0DP3O-51pM5pY0nVdJmYetS6HL59MW-axqcnCFCHsrnI15QBOmIPaO7y3Bsgnm6K7xAQG0P7eAiR2azqjQ0Fxy2Hi1FGA-OWnBw6Rmj9p3CNe21qY1yI0oooEDZgnDxD2oUdVk0k9x8Rj9GDg2iGz2RSa5U0WZTQMi62aDBp70hpRgbSdeYoxr5_jRgTLxomwC', stage: 'invoice' },
        'inv-998': { id: 'inv-998', code: '#INV-998', type: 'Material', project: 'Termin 1', title: 'Kabel NYM 3x2.5mm', vol: '1000 Meter', total: 'Rp 15.000.000', userAvatar: 'https://lh3.googleusercontent.com/aida-public/AB6AXuC_q8HhKA6LRO_ctAXqS3RASWeH0JCaOy9Hun-FRn2SZkdpK2Fa0iQdk5i6EcPV2fqcX2on3swESMZZIycuMK9T0RxzGrxd5WjahGWlFAf0KzEGt1MFlHZgMCIdJ3zQlh4L56GC2bjpfyCHaz0NpYrKkFpWsRXtN7Ie2XJFZSGw2X2FD5pwjfD4gIbfVXy3hINGeFpGIyEsNq_Vo0D1-gFceQNMfCwdW_TXQETpPGM5wKvlsAR7R8W36uLgSHzzFqhDKxNerxN9WpKS', due: 'Due in 2 days', stage: 'invoice' },
...
const applyPhaseStandard = (item, destPhase, formValues, isForward, isEdit = false) => {
    ...
    switch (destPhase) {
        case 'po':
            ...
            break;
        case 'invoice':
            const pStatus = getVal('paymentStatus') || 'Unpaid';
            phaseProps = {
                total: getVal('invoiceValue') || baseItem.total || 'Rp 0',
                status: pStatus === 'Belum Dibayar' ? 'Unpaid' : pStatus,
                due: getVal('invoiceDate') || 'TBD'
            };
            break;
        case 'do':
            phaseProps = {
